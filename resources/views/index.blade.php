...
<h4><a href="{{url('ad-details')}}">Iphonex 6 Plus Factor ...</a></h4>
<div class="meta-tag">
<span>
...
<h4><a href="{{url('ad-details')}}">Wooden Dining Tabl ...</a></h4>
<div class="meta-tag">
<span>
<a href="#"><i class="lni-user"></i> John Smith</a>
</span>
...
<a href="{{url('category')}}" class="img-box">
